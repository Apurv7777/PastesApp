        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 p-8  gap-2 sm:gap-8 auto-rows-max">
          {filteredData.length > 0 ? (
            filteredData.map((paste) => ( 
              <div key={paste._id} className="glass-card animate-scale-in transition-all duration-300 relative h-fit shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06),4px_0_6px_-1px_rgba(0,0,0,0.1),-4px_0_6px_-1px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_25px_-5px_rgba(0,0,0,0.1),0_4px_10px_-2px_rgba(0,0,0,0.05),8px_0_25px_-5px_rgba(0,0,0,0.1),-8px_0_25px_-5px_rgba(0,0,0,0.1)] dark:shadow-[0_6px_12px_-2px_rgba(255,255,255,0.08),0_4px_8px_-2px_rgba(255,255,255,0.05),6px_0_12px_-2px_rgba(255,255,255,0.08),-6px_0_12px_-2px_rgba(255,255,255,0.08),0_0_0_1px_rgba(255,255,255,0.05)] dark:hover:shadow-[0_12px_30px_-5px_rgba(255,255,255,0.12),0_8px_20px_-4px_rgba(255,255,255,0.08),12px_0_30px_-5px_rgba(255,255,255,0.12),-12px_0_30px_-5px_rgba(255,255,255,0.12),0_0_0_1px_rgba(255,255,255,0.1)] rounded-xl p-3 hover:-translate-y-2 hover:scale-105 cursor-pointer">
